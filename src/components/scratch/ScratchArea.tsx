...
export function ScratchArea({ 
  ...
  return (
    <div 
      ref={containerRef}
      className="relative aspect-[4/3] w-full max-w-md mx-auto overflow-hidden rounded-3xl border-4 border-primary/20 bg-surface shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] group/scratch"
      style={{
        perspective: '1000px'
      }}
    >
