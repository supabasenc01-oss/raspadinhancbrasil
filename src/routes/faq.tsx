  ...
  return (
    <PublicPage>
      <PageHero
        ...
        description="Tire suas dúvidas e aprenda a aproveitar o máximo da plataforma."
        centered
      />
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {FAQ_ITEMS.map((item, i) => (
                <AccordionItem 
                  key={i} 
                  value={`item-${i}`}
                  className="surface-card px-6 border border-border/50 rounded-2xl overflow-hidden"
                >
